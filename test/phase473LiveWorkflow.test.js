...
test('permanent Render workflow uses the Phase 4.7.5 mobile navigation verifier and status names',async()=>{
 ...
 assert.match(verifier,/phase-4-7-5-navigation-lock/);
