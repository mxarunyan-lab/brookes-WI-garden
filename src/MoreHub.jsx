...
import{Bell,ChevronDown,ChevronRight,CircleHelp,DatabaseBackup,Info,LifeBuoy,MapPin,Settings,Sprout}from'lucide-react';
...
export default function MoreHub({garden,navigate}){
 ...
 return <main className="screen more-screen">
  ...
  <section className="screen-pad more-content">
   ...
   <div className="more-group"><div className="more-group-heading"><span>PREFERENCES</span><small>Control how this device handles garden alerts.</small></div><div className="more-list"><LinkRow icon={Bell} title="Notification Settings" subtitle="Review in-app alerts and browser notification permission" onClick={()=>openProfile('notifications')}/></div></div>
