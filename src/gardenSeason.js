...
export const SEASONAL_GARDEN_HEADERS={
 spring:'/images/garden-headers/garden-header-spring.webp',
 summer:'/images/garden-headers/garden-header-summer.webp',
 fall:'/images/garden-headers/garden-header-fall.webp',
 winter:'/images/garden-headers/garden-header-winter.webp'
};
