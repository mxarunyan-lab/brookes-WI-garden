...
export const SEASONAL_GARDEN_HEADERS={
 spring:'/images/garden-headers/garden-header-spring.avif',
 summer:'/images/garden-headers/garden-header-summer.avif',
 fall:'/images/garden-headers/garden-header-fall.avif',
 winter:'/images/garden-headers/garden-header-winter.avif'
};
