...
import{buildGardenSubtitle,possessiveGardenTitle,resolveGardenHeaderSeason,SEASONAL_HEADER_IMAGES}from'./seasonalGardenHeader.js';
...
export function SeasonalGardenHeader({profile={},notificationControl,notificationPopover,date,seasonPreference='automatic'}){
 ...
 return <section className="seasonal-garden-header home-seasonal-header" data-season={season} aria-label={`${profile.gardenName||'Garden'} seasonal overview`}>
  <img className="seasonal-garden-header__image" src={SEASONAL_HEADER_IMAGES[season]} alt="" aria-hidden="true" loading="eager" fetchPriority="high" decoding="async"/>
