...
export const BUILD_ID='phase-4-8-3c-checklist-layout-hotfix';
export const UPDATED_AT='July 23, 2026';
export const WHATS_NEW=[
 'Fixed the first-time setup checklist layout on mobile.',
