...
export function prepareGardenForSync(garden){
 ...
 const collections=['spaces','plants','activity','seeds','seedPackets','harvests','problems','succession','trays','growLights','hardeningPlans','hydroPods','greenhouseReadings','reminders','taskHistory','plantingDecisions'];
 const prepared={...garden,schemaVersion:8,updatedAt:garden.updatedAt||nowIso()};
