...
export default function VacationMode({garden,weather,navigate,onSavePlan,onRefreshPlan,onUpdateTask,onCompleteTask,onClosePlan}){
 ...
 return <main className="screen secondary-screen vacation-mode-screen">
  <SecondaryHero icon={CalendarRange} eyebrow="CONNECTED TRIP CARE" title="Vacation Mode" description="A garden-specific before, during, and after plan built from actual plants, spaces, stages, care history, and weather." onBack={()=>navigate('center')} backLabel="Back to Garden Center" className="center-department-hero vacation-mode-hero"/>
