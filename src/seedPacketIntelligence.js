...
export function emptyPacketDraft(prefill={}){
 ...
 const base={draftId,operationId:prefill.operationId||`seed-packet-from:${draftId}`,schemaVersion:2,name:'',variety:'',brand:'',productName:'',category:'',packetYear:'',packedForYear:'',sellByDate:'',purchasePrice:'',quantity:'',originalQuantity:'',reservedQuantity:0,countType:'estimated',inventoryBasis:'unknown',printedSeedCount:null,estimatedSeedCount:null,estimatedSeedCountSource:'',estimatedSeedCountConfidence:'',packetWeight:'',lotNumber:'',barcode:'',barcodeFormat:'',barcodeStatus:'not-found',barcodeMethod:'',sku:'',catalogNumber:'',productCode:'',designations:[],notableClaims:'',colorDescription:'',daysToMaturity:'',maturityBasis:'',germinationEstimate:'',germinationTemperature:'',seedStartingGuidance:'',sowingMethod:'',directSowGuidance:'',transplantGuidance:'',seasonalWindow:'',frostTiming:'',depth:'',spacing:'',thinningSpacing:'',rowSpacing:'',sunlight:'',waterGuidance:'',soilGuidance:'',fertilizingGuidance:'',plantHeight:'',plantSpread:'',growthHabit:'',successionGuidance:'',harvestGuidance:'',harvestWindow:'',supportNeeds:'',specialCare:'',regionalGuidance:'',packetWarnings:'',treatmentInformation:'',seedSavingRestrictions:'',containerSuitability:'',notes:'',sourceShoppingItemId:'',visionAnalysisVersion:'',visionModel:'',visionAnalyzedAt:'',visionRequestId:'',imageHashes:{},analysisPassCount:0,packetIdentityConfidence:'',overallAnalysisConfidence:'',fieldEvidence:{},unreadableFields:[],contradictoryFields:[],exactIdentitySupportedByImages:false,successionRecommended:false,successionIntervalDays:null,successionReminderText:'',successionReason:'',analysisSourceSummary:'',fieldMeta:{},packetIntelligence:{front:null,back:null},draftStatus:'Draft'};
...
export function packetPayload(draft,{frontPhoto='',backPhoto='',imageMeta={}}={}){
 ...
 return{...draft,name:asText(draft.name),variety:asText(draft.variety),brand:asText(draft.brand),packetYear:numberOrNull(draft.packetYear),packedForYear:numberOrNull(draft.packedForYear),purchasePrice:numberOrNull(draft.purchasePrice),quantity:Math.max(0,numberOrNull(draft.quantity)||0),originalQuantity:numberOrNull(draft.originalQuantity),reservedQuantity:0,printedSeedCount:numberOrNull(draft.printedSeedCount),estimatedSeedCount:numberOrNull(draft.estimatedSeedCount),daysToMaturity:numberOrNull(draft.daysToMaturity),analysisPassCount:Math.max(0,numberOrNull(draft.analysisPassCount)||0),cropId:'',photo:frontPhoto||backPhoto||'',frontPhoto,backPhoto,imageMeta,packetIntelligence:draft.packetIntelligence||{front:null,back:null},fieldMeta:draft.fieldMeta||{},draftStatus:'Saved',savedAt:new Date().toISOString()};
}
