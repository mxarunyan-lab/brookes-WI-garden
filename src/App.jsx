...
export default function App(){
 ...
 return <div className="site-stage"><div className={`app-shell page-${page}`}>
  ...
  {page==='plan-plant'&&<PlanPlantHub recommendations={recommendations} setModal={setModal} garden={garden} timeline={timeline} completePlanItem={completePlanItem} updatePlantStage={updatePlantStage} recordHarvest={recordHarvest} scheduleSuccession={scheduleSuccession} saveYearPlan={saveYearPlan} onPlantingDecision={savePlantingDecision}/>} 
